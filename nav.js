...
(function () {
  ...
  var html = [
    ...
    // 모바일 드로어 — 플랫 펼침
    '<div class="nav-drawer" id="gcb-drawer" aria-label="모바일 메뉴">',
    '  <div class="nav-drawer-grid">',
    '    <div class="nav-drawer-col">',
    '      <a href="about.html" class="nav-drawer-head">회사소개</a>',
    '      <a href="about.html#greeting">인사말</a>',
    '      <a href="about.html#company">회사소개</a>',
    '      <a href="about.html#location">오시는길</a>',
    '    </div>',
    '    <div class="nav-drawer-col">',
    '      <a href="cdmo.html" class="nav-drawer-head">CDMO 서비스</a>',
    '      <a href="cdmo.html#cmo">CMO · 위탁생산</a>',
    '      <a href="cdmo.html#qc">QC · 위탁품질시험</a>',
    '      <a href="cdmo.html#ra">RA · 인허가 컨설팅</a>',
    '    </div>',
    '    <div class="nav-drawer-col">',
    '      <a href="cell-management.html" class="nav-drawer-head">인체세포등 관리업</a>',
    '      <a href="cell-management.html#supply">원료세포 공급</a>',
    '      <a href="cell-management.html#banking">자가세포 보관</a>',
    '    </div>',
    '    <div class="nav-drawer-col">',
    '      <a href="cell-facility.html" class="nav-drawer-head">세포처리시설</a>',
    '      <a href="cell-facility.html#cmo">투여용 세포 공급</a>',
    '      <a href="cell-facility.html#doc">치료계획서 작성 지원</a>',
    '    </div>',
    '    <div class="nav-drawer-col">',
    '      <a href="support.html" class="nav-drawer-head">고객지원</a>',
    '      <a href="support.html#qna">Q&amp;A</a>',
    '      <a href="support.html#contact">Contact Us</a>',
    '    </div>',
    '  </div>',
    '  <a href="support.html#contact" class="nav-drawer-cta">상담 신청 →</a>',
    '</div>',
    '</header>'
  ].join('\n');
