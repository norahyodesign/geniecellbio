...
(function () {
  ...
  var html = [
    ...
    '        <div class="nav-drop">',
    '          <a href="cdmo.html">CMO · 위탁생산</a>',
    '          <a href="cdmo.html">QC · 위탁품질시험</a>',
    '          <a href="cdmo.html">RA · 인허가 컨설팅</a>',
    '        </div>',
    '      </li>',
    // 인체세포등 관리업
    ...
    '        <div class="nav-drop">',
    '          <a href="cell-management.html">원료세포 공급</a>',
    '          <a href="cell-management.html">자가세포 보관</a>',
    '        </div>',
    '      </li>',
    // 세포처리시설
    ...
    '        <div class="nav-drop">',
    '          <a href="cell-facility.html">투여용 세포 공급</a>',
    '          <a href="cell-facility.html">치료계획서 작성 지원</a>',
    '        </div>',
    '      </li>',
    // 고객지원
